...
INFRASTRUCTURE_RESOURCE_GROUP_NAME="ai4e-api-backend-master-rg"     # Azure Resource Group
...
CONTAINER_REGISTRY_NAME="ai4eregistry"                              # ACR name
CONTAINER_REGISTRY_RESOURCE_GROUP="ai4e_registry_rg"

AKS_RESOURCE_GROUP_NAME="ai4e-api-backend-master-aks-rg"             # Azure Resource Group Name
AKS_CLUSTER_NAME="ai4e-api-backend-master"                           # AKS Cluster Name
KUBERNETES_VERSION="1.14.8"                                          # Kubernetes version to deploy
DNS_NAME_PREFIX="ai4e-api-backend-master"                            # Custom DNS prefix for your cluster
